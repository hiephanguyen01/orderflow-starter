"use strict";var _adapterPg = await jitiImport("@prisma/adapter-pg");
var argon2 = _interopRequireWildcard(await jitiImport("argon2"));
var _dotenv = await jitiImport("dotenv");

var _client = await jitiImport("../src/generated/prisma/client.js");function _interopRequireWildcard(e, t) {if ("function" == typeof WeakMap) var r = new WeakMap(),n = new WeakMap();return (_interopRequireWildcard = function (e, t) {if (!t && e && e.__esModule) return e;var o,i,f = { __proto__: null, default: e };if (null === e || "object" != typeof e && "function" != typeof e) return f;if (o = t ? n : r) {if (o.has(e)) return o.get(e);o.set(e, f);}for (const t in e) "default" !== t && {}.hasOwnProperty.call(e, t) && ((i = (o = Object.defineProperty) && Object.getOwnPropertyDescriptor(e, t)) && (i.get || i.set) ? o(f, t, i) : f[t] = e[t]);return f;})(e, t);}

(0, _dotenv.config)({ path: '../../.env' });
(0, _dotenv.config)();
...
const prisma = new _client.PrismaClient({
  adapter: new _adapterPg.PrismaPg({
